    ...
    <div className="pt-32 pb-20 min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden group">
                <div className="relative z-10">
                    ...
                    <p className="text-primary-100 mb-6">
                        Akses seluruh file juknis, materi, dan ketentuan teknis dalam satu folder Google Drive resmi.
                    </p>
                    <a 
                        href="#"
                        target="_blank"
            ...
            <div className="bg-white border-2 border-slate-200 rounded-2xl p-8 shadow-sm hover:border-primary-200 hover:shadow-lg transition-all relative overflow-hidden group">
                 <div className="relative z-10">
                    ...
                    <p className="text-slate-600 mb-6">
                        Pendaftaran offline dapat dilakukan dengan mengunjungi Sekretariat Panitia SGC 2026 di SMP Negeri 1 Genteng.
                    </p>
                    <div className="flex items-center gap-2 text-primary-700 font-bold bg-primary-50 p-3 rounded-xl">
                        <MapPin size={18} />
                        Sekretariat SMPN 1 Genteng
                    </div>
                </div>
        ...
        <div className="space-y-6 mb-16">
            <h2 className="text-2xl font-bold text-slate-800 mb-4 border-l-4 border-primary-600 pl-4">Dokumen Juknis Resmi</h2>
            {juknisList.map(item => (
                <div key={item.id} className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-6 py-2.5 rounded-xl font-bold transition-colors shadow-sm w-full md:w-auto justify-center"
                        >
                            <Download size={18} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                                ...
                                <ul className="space-y-3 text-sm text-slate-600">
                                    <li>Mengerjakan soal standar kompetisi nasional.</li>
                                    <li>Sistem skoring: Benar (+4), Salah (-1), Kosong (0).</li>
                                    <li>Terdiri dari babak penyisihan dan babak final.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                {activeTab === 'kreatif' && (
                    <div className="animate-fade-in space-y-8">
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                            ...
                            <ul className="space-y-3 text-sm text-slate-600">
                                <li><strong>Media:</strong> Kertas A4 (disediakan panitia).</li>
                                <li><strong>Peralatan:</strong> Peserta wajib membawa meja lipat dan alat warna sendiri.</li>
                                <li><strong>Tema:</strong> Akan diumumkan saat hari pelaksanaan sesuai juknis.</li>
                            </ul>
                        </div>
                    </div>
                )}
                    ...
                    <div className="animate-fade-in space-y-8">
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                            <p className="text-slate-700 leading-relaxed">
                                Simulasi pengerjaan soal standar nasional untuk mengukur kesiapan akademik siswa SD/MI. Hasil akan diberikan beserta skor detail evaluasi.
                            </p>
                        </div>
                    </div>
                )}
